package com.dzt.androidkit.widgets.slide;
...
public abstract class SlideViewHolder extends RecyclerHolder implements ISlide {
	...
	public SlideViewHolder(Context context, View itemView) {
