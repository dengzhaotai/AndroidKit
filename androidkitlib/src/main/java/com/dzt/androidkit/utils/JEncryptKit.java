...
import static com.dzt.androidkit.utils.JDataKit.bytes2HexString;
import static com.dzt.androidkit.utils.JDataKit.hexString2Bytes;

/**
 * Created by vondear on 2016/1/24.
 * 加密解密相关的工具类
 */
public class JEncryptKit {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return JEncodeKit.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(JEncodeKit.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return JEncodeKit.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(JEncodeKit.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return JEncodeKit.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(JEncodeKit.base64Decode(data), key);
    }
