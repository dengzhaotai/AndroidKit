...
import static com.dzt.androidkit.utils.JFileKit.getDataColumn;
import static com.dzt.androidkit.utils.JFileKit.isDownloadsDocument;
import static com.dzt.androidkit.utils.JFileKit.isExternalStorageDocument;
import static com.dzt.androidkit.utils.JFileKit.isGooglePhotosUri;
import static com.dzt.androidkit.utils.JFileKit.isMediaDocument;

/**
 * Created by vondear on 2016/1/24.
 */

public class JPhotoKit {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            JToastKit.getInstance().showMessage("请先获取写入SDCard权限");
        } else {
