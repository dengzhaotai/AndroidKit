...
public class JAppKit {
	...
	public static void installApp(Context context, String filePath) {
		context.startActivity(JIntentKit.getInstallAppIntent(context, filePath));
	}
	...
	public static void installApp(Context context, File file) {
		if (!JFileKit.isFileExist(file)) return;
	...
	public static void installApp(Activity activity, String filePath, int requestCode) {
		activity.startActivityForResult(JIntentKit.getInstallAppIntent(activity, filePath), requestCode);
	}
	...
	public static boolean installAppSilent(Context context, String filePath) {
		File file = JFileKit.getFileByPath(filePath);
		if (!JFileKit.isFileExist(file)) return false;
		String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
		JShellKit.CommandResult commandResult = JShellKit.execCmd(command, !isSystemApp(context), true);
	...
	public static void uninstallApp(Context context, String packageName) {
		...
		context.startActivity(JIntentKit.getUninstallAppIntent(packageName));
	}
	...
	public static void uninstallApp(Activity activity, String packageName, int requestCode) {
		if (TextUtils.isEmpty(packageName)) return;
		activity.startActivityForResult(JIntentKit.getUninstallAppIntent(packageName), requestCode);
	}
	...
	public static boolean isAppRoot() {
		JShellKit.CommandResult result = JShellKit.execCmd("echo root", true);
		if (result.result == 0) {
			return true;
		}
	...
	public static void launchApp(Context context, String packageName) {
		if (TextUtils.isEmpty(packageName)) return;
		context.startActivity(JIntentKit.getLaunchAppIntent(context, packageName));
	}
	...
	public static void launchApp(Activity activity, String packageName, int requestCode) {
		if (TextUtils.isEmpty(packageName)) return;
		activity.startActivityForResult(JIntentKit.getLaunchAppIntent(activity, packageName), requestCode);
	}
	...
	public static void getAppDetailsSettings(Context context, String packageName) {
		if (TextUtils.isEmpty(packageName)) return;
		context.startActivity(JIntentKit.getAppDetailsSettingsIntent(packageName));
	}
	 ...
	 * @return
	 */
	public static String getAppSignatureString(Context context) {
		return hexdigest(getAppSignature(context)[0].toByteArray());
	}
	...
	public static String getAppSignatureSHA1(Context context, String packageName) {
		...
		return JEncryptKit.encryptSHA1ToString(signature[0].toByteArray()).
	...
	public static boolean isAppForeground(Context context, String packageName) {
		return !TextUtils.isEmpty(packageName) && packageName.equals(JProcessKit.getForegroundProcessName(context));
	}
	//----------------------------------------------------------------------------------------------------------------
	...
	public static boolean isInstallApp(Context context, String packageName) {
		return !TextUtils.isEmpty(packageName) && JIntentKit.getLaunchAppIntent(context, packageName) != null;
	}
	...
	public static boolean cleanAppData(Context context, File... dirs) {
		boolean isSuccess = JFileKit.cleanInternalCache(context);
		isSuccess &= JFileKit.cleanInternalDbs(context);
		isSuccess &= JFileKit.cleanInternalSP(context);
		isSuccess &= JFileKit.cleanInternalFiles(context);
		isSuccess &= JFileKit.cleanExternalCache(context);
		for (File dir : dirs) {
			isSuccess &= JFileKit.cleanCustomCache(dir);
		}
		return isSuccess;
	}
